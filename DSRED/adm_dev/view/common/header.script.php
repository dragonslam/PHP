...
**/		
		if ($site_isDebug) {
			...
			PS_Script("common/common.js", "jCommon", true);
			PS_Script("common/common.function.js", "jFunction", true);
			PS_Script("common/common.string.js", "jString", true);
			PS_Script("common/common.date.js", "jDate", true);
			PS_Script("common/common.message.js", "jMessage", true);
			PS_Script("common/common.api.js", "jApi", false);
		}
		else {
			// 서비스용 릴리즈 버전
			...
			PS_Script("common/common.date.js", "jDate", true);
			PS_Script("common/common.message.js", "jMessage", true);
			PS_Script("common/common.api.js", "jApi", true);
		}
		...
		if (startWith($page_id, "statistics1") || startWith($page_id, "statistics2") || startWith($page_id, "statistics3") ||
			...
			if ($site_isDebug) {
				...
				PS_Script("plugin.d3/d3.chart.setting.js", "d3_chart_setting", false);
				PS_Script("plugin.d3/d3.chart.common.js", "d3_chart_common", false);
			}
			else {
