				...
				<nav class="tab_1">
					<ul>
						<li><a <?php PS_PageLink("statistics8")?>>최근 한달 공유 리스트</a></li>
						<li class="on"><a <?php PS_PageLink("statistics8a")?>>지난달 공유 리스트</a></li>
					</ul>
				</nav>
				<section class="cs1">
					<div class="h3_wrap">
...
$(document).ready(function(){
	...
	function getData(rowcnt, pagecnt, sort_type) {		
		...
		oStatictis.getLastMonthShare(p_rowcnt, p_pagecnt, p_sort_type, function(r) {		
			if (r.err == 0 && r.cnt > 0) {
				p_total_cnt = r.cnt;		
				p_data = r.ret;
