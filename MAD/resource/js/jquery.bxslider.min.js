...
$(document).ready(function(){var e=$(".slider").bxSlider({auto:!0,speed:300,autoControls:!0});$(".slider").find("img").mouseover(function(){e.stopAuto()});$(".slider").find("img").mouseout(function(){e.startAuto()})});